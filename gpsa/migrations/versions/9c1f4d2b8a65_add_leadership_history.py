...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_leadership_terms_academic_year", "leadership_terms", ["academic_year"], unique=False
    )
    op.create_index(
        "ix_leadership_terms_is_current", "leadership_terms", ["is_current"], unique=False
    )
    op.create_index(
        "ix_leadership_terms_sort_order", "leadership_terms", ["sort_order"], unique=False
    )
